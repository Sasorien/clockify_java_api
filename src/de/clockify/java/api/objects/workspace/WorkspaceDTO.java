...
public class WorkspaceDTO
{
    ...
    public WorkspaceDTO(HourlyRateDTO hourlyRate, String id, String imageUrl, List<MembershipDTO> memberships, String name, WorkspaceSettingsDTO workspaceSettings)
    {
